...
public class PrefixTree implements Collection<String> {
	...
	/*
	 * public static void main(String[] args) { PrefixTree tree = new PrefixTree(); tree.add("anton"); tree.add("berta"); tree.add("brett"); tree.add("brot"); tree.add("ei"); tree.add("end"); System.out.println(tree.getAll()); System.out.println(tree.get("")); System.out.println(tree.get("e")); } //
	 */
